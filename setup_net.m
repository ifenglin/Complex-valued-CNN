...
aff_layer1 = affine_layer(96, 128, learning_rate);
aff_layer2 = affine_layer(128, 128, learning_rate);
fiveway = affine_layer(128, 5, learning_rate);
class_layer = classification_layer('Magnitude', 5, 0.005, 0);
...
layer_vec = [aff_layer1 aff_layer2 fiveway class_layer];
layer_names = {'fc1', 'fc2', 'fiveway', 'classifier'};



%% setup blobs automatically - don't change here
blob_names = cell(length(layer_vec), 1);
parfor i=1:length(layer_vec)
%     blob_vec(i) = Blob();
